...
var base_graph = preload("res://scenes/base_graph.tscn")
var loop_graph = preload("res://scenes/loop.tscn")
var io_graph = preload("res://scenes/io_graph.tscn")
var neuron_graph = preload("res://scenes/neuron.tscn")
